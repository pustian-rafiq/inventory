...
function AddProduct(props) {
  ...
  const handleDbClick = (id, code, name, stock) => {
    const newObject = formData;
    newObject.code = code;
    newObject.name = name;
    props.damagedProductId(id);
    props.damagedProductStock(stock);
  ...
  return (
    <Fragment>
      <div className="row">
        ...
        <div
          className="col-xs-4 col-sm-3 col-md-1 col-lg-1 SearchIconField"
