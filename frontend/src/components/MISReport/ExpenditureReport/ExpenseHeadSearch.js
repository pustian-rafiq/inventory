...
const columns = [
  ...
  { id: "description", label: "Company Name", minWidth: 10 },
...
function ExpenseHeadSearch(props) {
    ...
    <Fragment>
      <div className="col-xs-12 col-sm-12 col-md-12 col-lg-2">
        <div className="input-group input-group-sm">
          <span className="spanTitle">Expense Head</span>
        </div>
      </div>
      ...
      <div className="col-xs-4 col-sm-5 col-md-4 col-lg-4 input-group input-group-sm">
        <input
          className="form-control productInput"
          type="text"
          placeholder="Name"
      ...
      >
        <Modal.Header style={{cursor: "move" }} className="background_and_table_header">
          <div >
            <h4 className="responsive-head"> Expense/Income Head </h4>
          </div>
...
export default ExpenseHeadSearch;
