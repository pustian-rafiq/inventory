...
const columns = [
  ...
  { id: "product_category", label: "Category Name", minWidth: 30 },
...
function ProductShowModal(props) {
          ...
          <TableRow
            ...
            onDoubleClick={() =>
              handleDbClick(
                stockDetail.id,
                stockDetail.product,
                stockDetail.product_code,
                stockDetail.product_category,
                stockDetail.product_name,
                stockDetail.quantity,
                stockDetail.stock,
                stockDetail.compressor_warrenty,
                stockDetail.panel_warrenty,
                stockDetail.motor_warrenty,
                stockDetail.spare_parts_warrenty,
                stockDetail.service_warrenty
              )
            }
          >
            {columns.map((column) => {
              // console.log(column.id)
              const value = stockDetail[column.id];
              return (
                <TableCell
  ...
  const handleDbClick = (
    ...
    // props.productStockQty(stockQty);
    // props.productStockId(stockId);
    // props.productStockDetailId(stockDetailId);
    // props.productCompressorWarrenty(compressor);
    // props.productPanelWarrenty(panel);
    // props.productMotorWarrenty(motor);
    // props.productSparepartWarrenty(sparepart);
    // props.productServiceWarrenty(service);
  ...
  return (
    <Fragment>
      <div className="row">
        <div className="col-sm-4 col-md-4 col-lg-5 input-group input-group-sm codeBox">
          <input
            type="text"
            placeholder="Code"
            defaultValue={props.code}
            readOnly
            className="form-control productInput input-group input-group-sm mr-2"
          />
        </div>
        <div
          className="col-sm-1 col-md-2 col-lg-2 SearchIconField"
        ...
        {/* <div className="col-sm-7 col-md-6  col-lg-1 input-group input-group-sm nameBox">
           
        </div> */}
        <div className="col-sm-7 col-md-6  col-lg-5 input-group input-group-sm nameBox">
          <input
        ...
        <Modal.Body sclassName="background_and_table_header">
          <div className="custom_modal_inner_content p-4">
            <div className="container-fluid ">
              <div className="row">
                <div className="col-md-12 pt-3 mr-4  ml-0 mt-2 showBox1">
                  <form
