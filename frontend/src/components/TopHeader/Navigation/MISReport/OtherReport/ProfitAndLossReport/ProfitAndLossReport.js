...
import { getProfitLossReport } from "../../../../../../redux/actions/reportActions";
import ProfitLossPrintTable from "./ProfitLossPrintTable";
...
const CashInHand = ({ show, onHide }) => {
  ...
  const submitHandler = (e) => {
    ...
    const dataSubmit = () => {
      dispatch(getProfitLossReport(formData, headers));
      setTableMOdal(true);
    };
