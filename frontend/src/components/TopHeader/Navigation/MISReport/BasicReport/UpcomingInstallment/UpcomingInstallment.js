...
import { getUpcommingInstallmentReport } from "../../../../../../redux/actions/reportActions";
...
const UpcomingInstallment = ({ show, onHide }) => {
  ...
  const submitHandler = (e) => {
    ...
    if (startDate && endDate) {
      dispatch(getUpcommingInstallmentReport(formData, headers));
      setTableMOdal(true);
    } else {
            ...
            <div className="row align-items-center">
              <div className="col-md-6 col-lg-6">
                <div className="row justify-content-between align-items-center">
                  <div className="col-3">
                    <span className="spanTitle">Month</span>
                  </div>
