...
import { getDefaultingCustomerReport } from "../../../../../../redux/actions/reportActions";
...
const ExepnseIncome = ({ show, onHide }) => {
  ...
  const submitHandler = (e) => {
    ...
    if (startDate && endDate) {
      dispatch(getDefaultingCustomerReport(formData, headers));
      setTableMOdal(true);
    } else {
          ...
          <Modal.Title id="example-modal-sizes-title-sm">
            <div>
              <h4 className=" responsive-head">
                Dafaulting Customer List Report
              </h4>
            </div>
          </Modal.Title>
        </Modal.Header>
