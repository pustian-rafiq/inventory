...
const PrintTable = React.forwardRef((props, ref) => {
  const { installment_collection_report } = useSelector(
    (state) => state.reports
  );
        ...
        <div className="report_modal_inner_content px-3">
          ...
          <div ref={ref} className="px-lg-5 mt-4">
                ...
                <h4 style={{ fontSize: "18px" }}>
                  Company Name:{" "}
                  {
                    installment_collection_report[
                      installment_collection_report.length - 1
                    ]?.name
                  }
                </h4>
            ...
            <div className="text-center mt-3">
              <p>Installment Collection Report</p>
            </div>
            ...
            <table className="print-receipt table-responsive">
              <thead>
                <tr className="thead">
                  ...
                  <th style={style}>Total Paid</th>
                  <th style={style}>Remaining</th>
                </tr>
              </thead>
              <tbody>
                {installment_collection_report[0]?.map((installmentData, i) => {
                  return (
                    <tr key={i}>
                      <td>
                      ...
                      <td>{installmentData?.installment_paid?.toFixed(2)}</td>
                ...
                >
                  ...
                  <td>{installment_collection_report[1]?.paid_amount}</td>
                  <td colSpan={2}></td>
                </tr>
              </tbody>
            </table>
