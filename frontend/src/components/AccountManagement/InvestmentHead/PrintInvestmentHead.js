...
const PrintInvestmentHead = React.forwardRef((props, ref) => {
        ...
        <Modal.Body style={{padding:'0px 5px 40px 5px' }} >
          ...
          <div className="mainDiv m-0 px-lg-5 mt-4" ref={ref}>
            ...
            style={{ border: "1px solid #000!important",marginBottom:'10px' }}>
              ...
              {shareInvestHeadLists.map((investmentList) => (
                <tr keys={investmentList.id}>
                  <td>{investmentList.code}</td>
                  <td>{investmentList.name}</td>
                </tr>
              ))}
            </table>
          </div>
...
export default PrintInvestmentHead;
