      ...
      if (supplier) {
        return (
          <TableRow
            ...
            key={supplier.id}
            onDoubleClick={() =>
              handleDbClick(supplier.id, supplier.code, supplier.name)
            }
          >
...
// When user double one row is selected and put the value in the form
  ...
  return (
    <Fragment>
      ...
      <div
        className="col-xs-3 col-sm-1 col-lg-2 searchInput text-center"
      ...
      <div className="col-xs-3 col-sm-6 col-md-4 col-lg-4 input-group input-group-sm nameBox">
        <input
