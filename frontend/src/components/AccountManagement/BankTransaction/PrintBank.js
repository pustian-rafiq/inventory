...
const PrintBank = React.forwardRef((props, ref) => {
      ...
      <Modal.Header style={{ cursor: "move" }} className="background_and_table_header">
        ...
        <Modal.Body >
          ...
          <div className="mainDiv m-0 px-lg-5 mt-4" ref={ref}>
            ...
            <p className="text-center mt-3 font-weight-bold"> Bank Transaction </p>
      ...
      <thead>
        <tr className="thead">
          ...
          >
              ...
              {bankTransactions.map((orderlist) => (
                <tr key={orderlist.id}>
                  <td>
                    {moment(orderlist.transaction_date).format("DD-MM-YYYY")}
                  </td>
                  <td>{orderlist.bank_name}</td>
                  <td>{orderlist.branch_name}</td>
                  <td>{orderlist.amount}</td>
                  <td>{orderlist.transaction_type}</td>
