...
const PrintExpenseIncome = React.forwardRef((props, ref) => {
      ...
      <div>
        ...
        >
          <div style={{ padding: "2px" }}>
            ...
            >
              Expense/Income Head Print Data     
            </h4>
          </div>
        ...
        <Modal.Body style={{ padding: "0px 5px 40px 5px" }}>
          ...
          <div className="mainDiv m-0 px-lg-5 mt-4" ref={ref}>
            ...
            >
              ...
              {expenseIncomeLists.map((exp_Icome) => (
                <tr key={exp_Icome.id}>
                  <td>{exp_Icome.code}</td>
                  <td>{exp_Icome.description}</td>
                  <td>{exp_Icome.status}</td>
                </tr>
              ))}
            </table>
          </div>
...
export default PrintExpenseIncome;
